...
public:
    ...
    StateSpace& stateSpace() { return *_stateSpace; }
    ...
    void reset(bool eraseRoot = false) {
        ...
        if (eraseRoot) {
            ...
            _nodemap.clear();
            _nodes.clear();
            _nodes.emplace_back(root, nullptr, _dimensions);
    ...
    virtual Node<T>* extend(const T& target, Node<T>* source = nullptr) {
        ...
        _nodes.emplace_back(intermediateState, source, _dimensions);
    ...
    void setStartState(const T& startState) {
        ...
        _nodes.emplace_back(startState, nullptr, _dimensions);
