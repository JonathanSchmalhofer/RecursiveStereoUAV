...
void StereoImageRpcClient::setPosition(msr::airlib::real_T position_x,
									   msr::airlib::real_T position_y, 
									   msr::airlib::real_T position_z, 
									   msr::airlib::real_T orientation_w, 
									   msr::airlib::real_T orientation_x, 
									   msr::airlib::real_T orientation_y, 
									   msr::airlib::real_T orientation_z )
{
	const bool ignore_collision = true;
	pclient_accessor_->client_.simSetPose(msr::airlib::Pose(msr::airlib::Vector3r(position_x, position_y, position_z), msr::airlib::Quaternionr(orientation_w, orientation_x, orientation_y, orientation_z)), ignore_collision);
}